...
void InputTexto::desenhar(int x, int y)
{
	...
	if (tamSelecao != 0)
	{
		...
		retan.x = (x) - txt.getLargura() / 2;
		retan.y = (y) - retan.alt / 2;
	...
	int xCursor = (x) - txt.getLargura() / 2;
	int yCursor = (y) - altCursor / 2;
